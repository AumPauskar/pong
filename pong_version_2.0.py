...
def BlueDown(): 
  ...
  elif bluedown_function=='inactive':
    pass
...
def RedDown():
  ...
  elif reddown_function=='inactive':
    pass
...
def Reset():
  ...
  global blueup_function ;global bluedown_function ;global redup_function ;global reddown_function
...
while True:
  ...
  if lpad.ycor()<=-(collision_lrpad):
    bluedown_function='inactive'

  if lpad.ycor()>=(collision_lrpad):
  	blueup_function='inactive'

  if rpad.ycor()<=-(collision_lrpad):
    reddown_function='inactive'

  if rpad.ycor()>=(collision_lrpad):
    redup_function='inactive'
